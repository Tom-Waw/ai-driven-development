...
class PlanningTemplate(Template):
    template = """
...
class SystemDesignTemplate(Template):
    template = """
...
def run_project_planning_chain(project_description: str) -> Project:
    ...
    results = user.initiate_chats(
        chat_queue=[
            ...
            {
                "recipient": assistant,
                "message": PlanningTemplate.render(),
                "max_turns": 1,
                "carryover": "requirements:",
            },
            {
                "recipient": assistant,
                "message": EvaluationTemplate.render(),
                "max_turns": 1,
                "carryover": "requirements and planning:",
            },
            {
                "recipient": assistant,
                "message": SystemDesignTemplate.render(),
                "max_turns": 1,
                "carryover": "requirements and planning:",
